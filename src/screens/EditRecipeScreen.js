    ...
    const handlePublish = async (editedRecipe) => {
        ...
        try {
            ...
            if (value !== null) {
                ...
                let updatedList = recipeList.filter(recipe => recipe.id !== editedRecipe.id) // removed old recipe
                        ...
                        <View style={{ marginBottom: 30 }}>
                            ...
                            <View style={styles.sectionWrapper}>
                                ...
                                <View style={styles.servingItemWrapper}>
                                    <Ionicons name="add-circle" color={colors.primaryOrange} size={25} onPress={() => {
                                        setcount(count + 1)
                                    }
                                    } />
